document.getElementById('grade-form').addEventListener('submit', function(event) {
            ...
            if (absences >= 4) {
                alert('You have FAILED the subject due to excessive absences.');
                return;
            }
            ...
            document.getElementById('midterm-result').textContent = `In order to pass with the semester (75%), you need a Midterm grade of ${midtermPass.toFixed(2)} and a Final grade of ${finalPass.toFixed(2)}.`;
            document.getElementById('final-result').textContent = `In order to become a Dean's Lister (90%), you need a Midterm grade of ${midtermDean.toFixed(2)} and a Final grade of ${finalDean.toFixed(2)}.`;
